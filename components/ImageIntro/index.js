   ...
   switch (variant) {
    case 'green':
       ...
       return(
        <div className="px-6 mb-16">
            ...
            <div className='bg-green-300 mb-6 '>
    ...
    return(
        <div className="px-6 mb-16">
            ...
            <div className='bg-purple-900 mb-6 '>
            <Link href='/#'><img src={url} alt="mockup"/></Link>
            </div>
            <Subtitle first_title='PRODUCT DESIGN' second_title='WEB DEVELOPMENT' />
            <Introduction title='Fiona: Engage &amp; Decide' subtitle='Fiona is a fintech consumer-facing website that enables users to search for financial products, discover them, and receive personalized recommendations.'/>
        </div>)
        case 'orange':
            return(
                <div className="px-6 mb-16">
                    
                    <div className='bg-thumborange mb-6 '>
                    <Link href='/#'><img src={url} alt="mockup"/></Link>
                    </div>
                    <Subtitle first_title='PRODUCT DESIGN' second_title='WEB DEVELOPMENT' third_title='QUALITY ASSURANCE' />
                    <Introduction title='Ukulele: The largest ukulele tabs archive' subtitle='Ukulele is the number one ukulele community, where players of any level can find the most complete tabs and chords. Cinnamon offered a complete platform redesign including expansions and new features, focusing on keeping the user longer on the website.'/>
                </div>)
